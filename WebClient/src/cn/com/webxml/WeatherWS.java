 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/Architecture/ep4/code/Client-demo02/src/Client/WeatherWS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:D:\\workSpace\\idea\\code\\SA4\\WebClient\\src\\Client\\WeatherWS.wsdl");
